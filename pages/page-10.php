    ...
    <div class="index--1_container">
        ...
        <div class="index--2_container">
            ...
            <div class="index--1_content">
                ...
                <div class="page-10-container">
                    <div class="page-10-text">Page 10</div>
                    <div class="wasnt-container">
                        <div class="wasnt-f">
                            <div class="wasnt-text">Wasn't That Great?!!</div>
                            <div class="wasnt-text">This is my last trimester</div>
                            <div class="wasnt-text">See you ✌🏻</div>
                        </div>
                        <div class="wasnt-s">
                            <div class="wasnt-text">MMXXIII</div>
                        </div>
                    </div>
                </div>
